...
public class CollectService {
	...
	/**
	 * Get request by keywords ore by keywordAny if keyword is null or empty
	 * @param keywords
	 * @param keywordsAny
	 * @return Record requests
	 */
	public Set<Request> requestConstainsCriteriasWithPriority(Set<String> keywords, Set<String> keywordsAny) {
		// PR1 : if request contains keyword
		if ((keywords == null || keywords.size() == 0) && keywordsAny != null) {
