...
public class UserPropertiesManager {
	...
	@Value("${application.twint-wrapper.twint.limit.min}")
	private int scrappingLimitMin;

	@Value("${application.twint-wrapper.twint.limit.medium}")
	private int scrappingLimitMedium;

	@Value("${application.twint-wrapper.twint.limit.max}")
	private int scrappingLimitMax;

	@Value("${application.twint-wrapper.twint.limit.default}")
