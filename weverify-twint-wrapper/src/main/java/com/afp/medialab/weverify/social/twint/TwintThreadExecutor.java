...
public class TwintThreadExecutor {
   ...
   @Value("${application.twint-wrapper.twintcall.nb-core-threads}")
   private int nbCoreThreads;
   @Value("${application.twint-wrapper.twintcall.nb-max-threads}")
   private int nbMaxThreads;
   @Value("${application.twint-wrapper.twintcall.nb-queue-threads}")
   private int nbQueueThreads; 
   
   @Value("${application.twint-wrapper.twintcall.grp-nb-core-threads}")
   private int nbCoreGroupThreads;
   @Value("${application.twint-wrapper.twintcall.grp-nb-max-threads}")
