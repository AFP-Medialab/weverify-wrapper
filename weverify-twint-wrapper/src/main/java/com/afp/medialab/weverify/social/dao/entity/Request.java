...
public class Request implements Serializable {
	 ...
	 * @param merge
	 */
	protected Request(Set<String> keywordList, Set<String> keywordAnyList, Set<String> bannedWords, String language,
			Set<String> userList, Date since, Date until, String media, boolean merge) {
	...
	public Request(CollectRequest collectRequest) {
		// set merge to false if cache is enable
		// set merge to true is cache is disable
		this(collectRequest.getKeywordList(), collectRequest.getKeywordAnyList(), collectRequest.getBannedWords(),
				...
				collectRequest.getUntil(), collectRequest.getMedia(), !collectRequest.isCached());
	}
	 ...
	 */
	private void update(CollectRequest collectRequest) {
