...
public class JwtCreateRegistrationRequest implements Serializable {
	...
	@Schema(description = "User's email addresse and login identifier.", required = true,
			example = "email@address.com")
	public String email;
	@Schema(description = "User's first name.", required = true, example = "John")
	@NotBlank(message = "Firstname is required")
	public String firstName;
	@Schema(description = "User's last name.", required = true, example = "SMITH")
	@NotBlank(message = "Lastname is required")
	public String lastName;
	@Schema(description = "User's organization name.", required = true, example = "RICK SPIRIT")
	@NotBlank(message = "Organization is required")
	public String organization;
	@NotNull(message = "Role is required")
	@Schema(description = "User's role within organization.", required = true, example = "FAKE_NEWS_CHECKER")
	public JwtUserOrganizationRole organizationRole;
	@Schema(description = "User's role within organization (if OTHER).", required = true, example = "Tester")
	public String organizationRoleOther;
	@Schema(description = "User's preferred languages.", required = false, example = "[ \"fr\", \"en\" ]")
	public List<Locale> preferredLanguages;
	@Schema(description = "User's timezone ID.", required = false, example = "Europe/Paris")
