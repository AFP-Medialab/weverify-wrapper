...
public class JwtUser implements Serializable {
	...
	@Schema(description = "User's identifier.", required = true, example = "1b941adc-8e55-4f40-801d-614fd8a6318d")
	public UUID id;
	@Schema(description = "User's email addresse and login identifier.", required = true, example = "email@address.com")
	public String email;
	@Schema(description = "True if user account is activated.", example = "true")
	public boolean active;
	@Schema(description = "User account expiration date.", example = "true")
	public ZonedDateTime expiry;
	@Schema(description = "User's first name.", example = "John")
	public String firstName;
	@Schema(description = "User's last name.", example = "SMITH")
	public String lastName;
	@Schema(description = "User's organization name.", example = "RICK SPIRIT")
	public String organization;
	@Schema(description = "User's role within organization.", example = "FAKE_NEWS_CHECKER")
	public JwtUserOrganizationRole organizationRole;
	@Schema(description = "User's role within organization (if OTHER).", example = "Tester")
	public String organizationRoleOther;
	@Schema(description = "User's preferred languages.", example = "[ \"fr\", \"en\" ]")
	public List<Locale> preferredLanguages;
	@Schema(description = "User's timezone ID.", example = "Europe/Paris")
